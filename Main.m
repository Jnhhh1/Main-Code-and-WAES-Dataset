...
self_correlation_matrix = SRMSimulate(T_dist,sys_param,SRM_param,1);
...
%DrawInvPic1(inv_T,SRM_param.norm_min_spacing,IAM_param.inverse_name,extent_UV1,Fov1,save_folder, resolution_dpi, fig_size_cm);
DrawInvPic(inv_T,SRM_param.norm_min_spacing,IAM_param.inverse_name,extent_UV1,Fov1);


% Cal_T_dist = CASsimulate(Fov,delta,CAS_param,sys_param.div);

% Cal_self_correlation_matrix = SRMSimulate(Cal_T_dist,sys_param,SRM_param,0);
...
% [inv_T2,extent_UV2,Fov2] = IAMSimulate(Calibrated_self_correlation_matrix,SRM_param,IAM_param);


% inv_TT = TAbsCalibration(inv_T2,IAM_param.inverse_name);
...
% Cal_self_correlation_matrix = SRMSimulate(Cal_T_dist,sys_param,SRM_param,2);
