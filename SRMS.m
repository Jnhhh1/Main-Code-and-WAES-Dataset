...
self_correlation_matrix = SRMS(T_dist,norm_ant_pos,norm_min_spacing,real_coef_matrix,mutual,T_rec,error_amp,error_Iphase,error_Qphase);


self_correlation_matrix = SRMC(self_correlation_matrix,sampling_num,error_Qphase);
